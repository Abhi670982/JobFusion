...
export const metadata: Metadata = {
  title: 'Pricing — JobFusion | Simple, Transparent Plans',
  description:
  ...
  keywords: ['job search pricing', 'resume AI subscription', 'ATS optimization plan', 'JobFusion Pro'],
  openGraph: {
    title: 'JobFusion Pricing — Invest in Your Career Growth',
    description:
