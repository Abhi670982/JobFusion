...
The JSON schema must contain precisely:
{
  ...
  "scores": {
    ...
    "projects": { "score": 0-100, "maxScore": 100, "reason": "Scope, architecture, SaaS production vs CRUD", "evidence": ["Built JobFusion AI platform..."], "positives": ["positives"], "problems": ["problems"], "recruiterPerspective": "perspective", "atsPerspective": "perspective", "improvements": ["improvements"], "expectedScoreAfterFix": 0-100, "priority": "high|medium|low" },
